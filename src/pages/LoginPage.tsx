    ...
    if (!result.success) {
      setError(
        result.error === 'unauthorized'
          ? 'Accesso non autorizzato. Questo account Google non è abilitato.'
          : 'Errore durante il login. Riprova.'
      )
      setLoading(false)
    }
    // Se ha successo, useAuth aggiornerà lo stato e scatterà il redirect
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8 border border-gray-200">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-blue-600 mb-2">Manti Finance</h1>
          <p className="text-gray-600">Personal Finance Copilot</p>
        </div>

        <h2 className="text-xl font-semibold mb-6 text-center">Accedi</h2>
        ...
        <p className="mt-8 text-center text-xs text-gray-500">
          L&apos;accesso è limitato agli utenti autorizzati.
        </p>
      </div>
    </div>
  )
